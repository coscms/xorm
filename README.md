...
* SQL Builder support via [github.com/coscms/xorm/builder](https://github.com/coscms/xorm/builder)
...
* **v0.6.0**
    ...
    * add query condition builder support via [github.com/coscms/xorm/builder](https://github.com/coscms/xorm/builder), so `Where`, `And`, `Or` 
